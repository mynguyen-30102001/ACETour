...
function init_header_ui() {
    $(".btn-side-menu").click(function () {
        ...
        $(":root").toggleClass("state-sidebar")
    }), 0 < $("#btn-search-mobile").length, $("#destinations_link").click(function () {
...
function init_widget_ui() {
    var t = !0;
    is_mobile_screen() && "/" == window.location.pathname && (t = !1), 0 < $("#TA_selfserveprop857").length && t && load_tripadvisor("TA_selfserveprop857", "en"), 0 < $(".travel-guide").length && init_travel_guide(), 0 < $(".indochina-countries").length
}
...
function init_search_form_ui() {
    if (0 < $("#frm_tour_search").length) {
        ...
        }), set_help(".glyphicon-info-sign"), set_help(".glyphicon-question-sign")) {
            var t = [];
        }
...
function init_datepicker_ui() {
    0 < $(".bpdatepicker").length && ($(".bpdatepicker").each(function () {
        ...
        }), "" == t && "" != $(r).val() && (t = $(r).val()), init_datepicker(n, o, r, i, t), 1 == e) (new Loader).require(["https://www.bestpricevn.com/assets/libs/jquery-ui-1.11.2.datepicker/jquery-datepicker-ui.min.css", "https://www.bestpricevn.com/assets/libs/jquery-ui-1.11.2.datepicker/jquery-ui.event.move.en.min.04041124.js"], function () {
...
init_ui = function () {
    _load_header(), init_search_text(), init_search_form_ui(), init_header_ui(), init_widget_ui(),  0 < $(".popular-routes").length && init_popular_flights(), 0 < $(".free-flight-popup").length && set_modal(".free-flight-popup"), 0 < $(".flight-destinations").length && init_flight_destinations(), 0 < $(".quick-contact-modal").length && $(".item .modal-quick-contact").click(function (t) {
        t.stopPropagation();
        var e = $(this).attr("data-target");
        $(e).modal()
    }), 0 < $("#btn-core-value").length && (is_mobile_screen() ? (set_popover(".core-value .policy-1"), set_popover(".core-value .policy-2"), set_popover(".core-value .policy-3")) : set_popover(".core-value .policy", "hover")), 0 < $(".book-width-confident").length && (is_mobile_screen() ? set_popover(".book-width-confident") : set_popover(".book-width-confident", "hover")), 0 < $(".flash-sale").length && init_flash_sale_time(), 0 < $(".div-ad-area").length && get_advertises(), init_footer_ui()
}, is_mobile_screen = function () {
