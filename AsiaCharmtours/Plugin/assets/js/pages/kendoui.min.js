$(function () {
    ...
    kendoUI = {
        autocomplete_widget: function () {
            var n = $("#kUI_automplete_template");
            n.length && n.kendoAutoComplete({
                minLength: 2,
        ...
        datetimepicker_widget: function () {
            var e = $("#kUI_datetimepicker_basic");
            e.length && e.kendoDateTimePicker({
                value: new Date
            });
            var t = $("#kUI_datetimepicker_range_start")
                , a = $("#kUI_datetimepicker_range_end");
            if (t.length && a.length) {
                var n = kendo.date.today()
                    , o = t.kendoDateTimePicker({
                        value: n,
                        change: function () {
                            var e = o.value()
                                , t = i.value();
                            e ? ((e = new Date(e)).setDate(e.getDate()),
                                i.min(e)) : t ? o.max(new Date(t)) : (t = new Date,
                                    o.max(t),
                                    i.min(t))
                        },
                        parseFormats: ["MM/dd/yyyy"]
                    }).data("kendoDateTimePicker")
                    , i = a.kendoDateTimePicker({
                        value: n,
                        change: function () {
                            var e = i.value()
                                , t = o.value();
                            e ? ((e = new Date(e)).setDate(e.getDate()),
                                o.max(e)) : t ? i.min(new Date(t)) : (e = new Date,
                                    o.max(e),
                                    i.min(e))
                        },
                        parseFormats: ["MM/dd/yyyy"]
        ...
        dropdownList_widget: function () {
            ...
            var t = $("#kUI_dropdown_basic_select");
            t.length && t.kendoDropDownList()
        },
        ...
        multiselect_widget: function () {
            ...
            var e2 = $("#kUI_multiselect_basic2");
            e2.length && e2.kendoMultiSelect();
        ...
        timepicker_widget: function () {
            var e = $("#kUI_timepicker");
            e.length && e.kendoTimePicker();
            var t = $("#kUI_timepicker_range_start")
                , a = $("#kUI_timepicker_range_end");
            if (t.length && a.length) {
                var n = t.kendoTimePicker({
                    change: function () {
                        var e = n.value();
                        e && (e = new Date(e),
                            o.max(e),
                            e.setMinutes(e.getMinutes() + this.options.interval),
                            o.min(e),
                            o.value(e))
                    }
                }).data("kendoTimePicker")
                    , o = a.kendoTimePicker().data("kendoTimePicker");
                n.min("8:00 AM"),
                    n.max("6:00 PM"),
                    o.min("8:00 AM"),
                    o.max("7:30 AM")
