var urlGet = '/api/author/get';
var urlPost = '/api/author/post';
var urlDetail = '/api/author/detail';
var urlPut = '/api/author/put';
var urlDelete = '/api/author/delete';

app.controller('controller', ['$scope', '$http', 'template', 'validation', 'helper', 'notify', function ($scope, $http, template, validation, helper, notify) {
    $scope.filters = {
        pageNumber: 1,
        pageSize: 100,
    };
    ...
    $scope.Get = function () {
        $http({
            ...
            $scope.gridOptions.data = data.authors;
