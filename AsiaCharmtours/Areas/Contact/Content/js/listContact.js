var urlGetContact = '/api/contact/get';
var urlDeleteContact = '/api/contact/delete';
var urlDetailContact = '/api/contact/detail';
...
app.controller('controller', ['$scope', '$http', 'template', '$timeout', 'helper', 'validation', 'notify', function ($scope, $http, template, $timeout, helper, validation, notify) {
    ...
    $scope.gridOptions.columnDefs = [
        ...
        },
        {
            ...
            width: 120,
            field: "#",
            cellTemplate: template.templateActionMethodView('ContactId'),
            enableFiltering: false,
            enableSorting: false,
            cellClass: 'text-center-grid',
            headerCellClass: 'text-center-grid'
