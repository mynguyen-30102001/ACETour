var urlGet = '/api/cruisetour/get';
var urlPost = '/api/cruisetour/post';
var urlDetail = '/api/cruisetour/detail';
var urlPut = '/api/cruisetour/put';
var urlDelete = '/api/cruisetour/delete';
...
app.controller('controller', ['$scope', '$http', 'template', '$timeout', 'helper', 'validation', 'notify', function ($scope, $http, template, $timeout, helper, validation, notify) {
    ...
    $scope.gridOptions.columnDefs = [
        {
            displayName: "Tên lịch trình",
            name: 'CruiseTourTypeName',
            width: '*',
            minWidth: 200
        },
        {
        ...
        },
        {
            ...
            width: 120,
            field: "#",
            cellTemplate: template.templateActionMethod('CruiseTourTypeId'),
            enableFiltering: false,
            enableSorting: false,
            cellClass: 'text-center-grid',
            headerCellClass: 'text-center-grid'
    ...
    $scope.Get = function () {
        ...
        $http({
            ...
            $scope.gridOptions.data = data.cruiseTours;
    ...
    $scope.Delete = function () {
        ...
        $http({
            ...
            method: 'GET',
            params: {
                _cruiseTourTypeId: $scope.menuIdChoose
            }
        }).then(function success(response) {
            notify.spinerHide();
